...
function ProductTable({ columns, rows, rowPerPage, categoriesSelect, handleDelete, handleUpdate }) {
                        ...
                        {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                            return (
                                <TableRow hover role="checkbox" tabIndex={-1} key={row.index}>
                                    ...
                                    <StyledTableCell align="left">{row?.price.toLocaleString('vn-VN') + ' đ'}</StyledTableCell>
                                            ...
                                            <div className={cx('update-modal-box')}>
                                                ...
                                                <div className={cx('update-input-wrapper')}>
                                                    ...
                                                    <div className={cx('update-input-row')}>
                                                        <p>Giá sau giảm</p>
                                                        <input
                                                            id={`product-discount-price-${row.index - 1}`}
                                                            type="number"
                                                    ...
                                                    <div className={cx('update-input-row')}>
                                                        <p>Số lượng hàng</p>
                                                        <input
                                                            id={`product-quantity-${row.index - 1}`}
                                                            type="number"
