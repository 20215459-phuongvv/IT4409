...
import com.IT4409.backend.dtos.MessageGroupDTO.MessageGroupDTO;
...
public class MessageService {
    ...
    public void sendMessage(String to, MessageDTO messageDTO){
        jdbcTemplate.update(
                ...
                "values (?, ?, ?, current_time )",
                messageDTO.getMessage(), messageDTO.getFromLogin(), to);
    ...
    public void sendMessageGroup(long to, MessageGroupDTO messageGroupDTO){
        jdbcTemplate.update(
